...
public class Game {
    ...
    public void quaffleScore(Team team) {
        this.scoreboard.put(team, this.getScore(team) + QUAFFLE_POINTS);
        
    }

    public void catchSnitch(Team team) {
        this.scoreboard.put(team, this.getScore(team) + SNITCH_POINTS);
    }
    ...
    public String simmulate(String play) {
